...
$stmt=$pdo->prepare("SELECT k.*, e.baslik as ekipman_baslik, e.kategori, u.ad_soyad as kiralayan_adi FROM kiralamalar k JOIN ekipmanlar e ON k.ekipman_id=e.id JOIN kullanicilar u ON k.kiralayan_id=u.id WHERE e.sahip_id=:id ORDER BY k.created_at DESC");
